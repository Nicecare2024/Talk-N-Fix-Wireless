                ...
                <div className="bg-zinc-900 text-white p-5 sm:p-8 rounded-2xl relative overflow-hidden">
                  ...
                  <div className="space-y-3">
                    <a href="tel:9737785900" className="flex items-center gap-3 group">
                      ...
                      <div>
                        <span className="block text-[10px] font-bold text-stone-500 uppercase tracking-widest">Call Specialist</span>
                  ...
                  <>
                    ...
                    <form onSubmit={submit} className="space-y-5">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                          <label className="block text-[10px] font-bold text-stone-600 uppercase tracking-widest mb-2">Name *</label>
                          <input required type="text" value={form.name} onChange={e => set("name", e.target.value)} placeholder="Your name"
                            className="w-full bg-zinc-200 border-none rounded-xl px-4 py-3 text-zinc-900 text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#0050d7]/20 transition-all" />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-stone-600 uppercase tracking-widest mb-2">Phone *</label>
                          <input required type="tel" value={form.phone} onChange={e => set("phone", e.target.value)} placeholder="Your phone"
                            className="w-full bg-zinc-200 border-none rounded-xl px-4 py-3 text-zinc-900 text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#0050d7]/20 transition-all" />
                        </div>
                      </div>
                      <div>
                        <label className="block text-[10px] font-bold text-stone-600 uppercase tracking-widest mb-2">Email</label>
                        <input type="email" value={form.email} onChange={e => set("email", e.target.value)} placeholder="your@email.com"
                          className="w-full bg-zinc-200 border-none rounded-xl px-4 py-3 text-zinc-900 text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#0050d7]/20 transition-all" />
                      </div>
                      <div>
                        <label className="block text-[10px] font-bold text-stone-600 uppercase tracking-widest mb-2">Primary Symptom</label>
                        <select value={form.device} onChange={e => set("device", e.target.value)}
                          className="w-full bg-zinc-200 border-none rounded-xl px-4 py-3 text-zinc-900 text-sm focus:outline-none focus:ring-2 focus:ring-[#0050d7]/20 transition-all">
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-stone-600 uppercase tracking-widest mb-2">Preferred Location</label>
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-stone-600 uppercase tracking-widest mb-2">Additional Context *</label>
                        <textarea required rows={4} value={form.message} onChange={e => set("message", e.target.value)}
                          ...
                          className="w-full bg-zinc-200 border-none rounded-xl px-4 py-3 text-zinc-900 text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#0050d7]/20 transition-all resize-none" />
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <label htmlFor="sms" className="text-xs text-stone-600 leading-relaxed">
