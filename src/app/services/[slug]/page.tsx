        ...
        <section className="relative px-4 sm:px-6 py-12 sm:py-20 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-12 items-center">
            <div>
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-zinc-900 mb-5 leading-[1.05]" style={{ fontFamily: "Plus Jakarta Sans" }}>
                {service.title}<br />
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -left-5 bg-white p-5 rounded-2xl shadow-card max-w-[200px] border border-zinc-100">
                ...
                <p className="text-stone-600 text-xs mt-1">While you wait in-store</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {LOCATIONS.map(loc => (
                <div key={loc.id} className="bg-zinc-100 rounded-2xl p-6 hover:bg-white hover:shadow-lg transition-all border border-transparent hover:border-zinc-200">
                  ...
                  <p className="text-stone-600 text-xs mb-4">{loc.cityStateZip}</p>
        ...
        <section className="py-16 bg-white px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              {related.map(s => (
                <Link key={s.id} href={`/services/${s.id}`} className="bg-zinc-100 rounded-2xl p-6 hover:bg-white hover:shadow-lg transition-all group block border border-transparent hover:border-zinc-200">
                  ...
                  <p className="text-stone-600 text-xs mt-1">{s.time} · Same Day</p>
                </Link>
              ))}
            </div>
          </div>
