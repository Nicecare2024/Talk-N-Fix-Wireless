      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-10 sm:mb-12">
          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-1">
            ...
            <p className="text-zinc-500 text-xs block mb-4 italic">
              Build on speed, quality and trust.
            </p>
            {/* Social icons */}
            ...
            <a
              href="/financing"
              className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-200 hover:bg-red-700 hover:text-white text-zinc-700 text-xs font-bold transition-all"
            >
          ...
          <div>
            ...
            <div>
              <p className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-2">Have Questions?</p>
              <p className="text-xs text-zinc-500 mb-2">Our chatbot handles 90% of questions instantly.</p>
              <ChatTrigger />
            </div>
          </div>
        </div>
